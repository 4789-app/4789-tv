...
internal class WebSocketClientRegistry(
    ...
    private companion object {
        ...
        // Notifications are ordered by the upstream event collector. A dead peer must be evicted
        // inside the receiver→phone UI budget instead of holding every later event for five seconds.
        const val DEFAULT_CLIENT_OPERATION_TIMEOUT_MILLIS = 400L
    }
}
