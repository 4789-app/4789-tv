...
- A Downloader shortcut may be created only after the final APK is hosted at a stable public HTTPS URL. It must be a public numeric shortcut created and tested through the AFTVnews Downloader URL Shortener.
- The stable Downloader code is **6364713** and must always be verified against the hosted APK.
